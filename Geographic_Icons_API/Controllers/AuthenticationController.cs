...
using ChallengeAlternativo.API.ViewModels.Auth.Login;
using ChallengeAlternativo.API.ViewModels.Auth.Register;
...
namespace ChallengeAlternativo.API.Controllers
{
    [Route("api/")]
    [ApiController]
